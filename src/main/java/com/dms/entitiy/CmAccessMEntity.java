...
@Entity
@Table(name = "CM_ACCESS_M", schema = "dbo")
@IdClass(CmAccessMEntityPK.class)
public class CmAccessMEntity {
  ...
  public boolean equals(Object o) {
    ...
    CmAccessMEntity that = (CmAccessMEntity) o;
    return Objects.equals(accessId, that.accessId) &&
        Objects.equals(accessNm, that.accessNm) &&
  ...
  public int hashCode() {
    return Objects
        .hash(accessId, accessNm, plantId, description, useYn, createDt, createUserId, updateDt,
