...
@Entity
@Table(name = "CM_ACCESS_MENU_R", schema = "dbo")
@IdClass(CmAccessMenuREntityPK.class)
public class CmAccessMenuREntity {
  ...
  public boolean equals(Object o) {
    ...
    CmAccessMenuREntity that = (CmAccessMenuREntity) o;
  ...
  public int hashCode() {
    return Objects
        .hash(accessId, menuId, plantId, description, useYn, createDt, createUserId, updateDt,
